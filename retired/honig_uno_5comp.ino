...
int conveyorPrice[5] = {500, 500, 500, 500, 200}; // default price  6
...
// Wird nur ausgeführt, wenn die Leerlaufperiode seit dem letzten Lauf erreicht wurde und keine Münzen geworfen wurden
...
// Im Leerlauf werden nur Textnachrichten angezeigt, wenn der Akku nicht im Energiesparmodus ist
   if (powersave == 0)
 {   
...
// alle leeren Felder öffnen und setzen Wert auf maxrow
